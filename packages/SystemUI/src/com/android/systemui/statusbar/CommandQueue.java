...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_DISABLE_CAMERA_FLASH          = 50 << MSG_SHIFT;
    ...
    public interface Callbacks {
        ...
        default void disableCameraFlash() { }
    ...
    public void disableCameraFlash() {
        synchronized (mLock) {
            mHandler.removeMessages(MSG_DISABLE_CAMERA_FLASH);
            mHandler.sendEmptyMessage(MSG_DISABLE_CAMERA_FLASH);
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_TOGGLE_CAMERA_FLASH:
                    ...
                    break;
                case MSG_DISABLE_CAMERA_FLASH:
                    for (int i = 0; i < mCallbacks.size(); i++) {
                        mCallbacks.get(i).disableCameraFlash();
                    }
                    break;
