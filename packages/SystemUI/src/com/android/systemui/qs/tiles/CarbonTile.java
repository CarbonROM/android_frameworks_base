...
public class CarbonTile extends QSTileImpl<BooleanState> {
    ...
    private final Icon mIcon = ResourceIcon.get(drawable.ic_carbon);
    ...
    public void handleClick() {
        Toast.makeText(getBaseContext(), getString(R.string.quick_settings_carbon_toast), Toast.LENGTH_SHORT).show();
        refreshState();
    }
