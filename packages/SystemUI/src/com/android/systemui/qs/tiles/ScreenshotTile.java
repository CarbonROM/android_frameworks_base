...
public class ScreenshotTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        if (currTileSelection == 1) {    //regular screenshot
        ...
        } else if (currTileSelection == 2) {    //region screenshot
        ...
        } else if (currTileSelection == 3) {    //extended screenshot
            Log.w("System UI", "Screenshot tile created");
