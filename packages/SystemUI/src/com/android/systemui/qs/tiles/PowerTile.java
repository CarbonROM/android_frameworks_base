...
public class PowerTile extends QSTileImpl<BooleanState> {
    ...
    int mTileMode = 1;
    int mRebootMode = Settings.System.getInt(mContext.getContentResolver(),
    ...
    public String preferenceSelected() {
          ...
          switch(selected) {
            case 2:
                return pm.REBOOT_RECOVERY;
            case 3:
                return pm.REBOOT_BOOTLOADER;
            case 1:
            default:
                return null;
          }
    ...
    private class PowerDetailAdapter implements DetailAdapter, View.OnClickListener {
        ...
        public View createDetailView(Context context, View convertView, ViewGroup parent) {
            ...
            final RadioButton radio_system = mDetails.findViewById(R.id.radio_system);
            radio_system.setOnClickListener(this);
            final RadioButton radio_recovery = mDetails.findViewById(R.id.radio_recovery);
            radio_recovery.setOnClickListener(this);
            final RadioButton radio_bootloader = mDetails.findViewById(R.id.radio_bootloader);
            ...
            switch (v.getId()) {
                case R.id.radio_system:
                    ...
                    Settings.System.putInt(mContext.getContentResolver(),
                        Settings.System.STATUS_BAR_LAST_NOTIFICATION_STYLE, mRebootMode);
                    mTileMode = 2;
                    refreshState();
                    break;
