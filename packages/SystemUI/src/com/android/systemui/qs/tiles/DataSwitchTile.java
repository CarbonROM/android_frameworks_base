...
public class DataSwitchTile extends QSTileImpl<BooleanState> {
    ...
    @Inject
    public DataSwitchTile(QSHost host, NetworkController networkController) {
        super(host);
        mTelephonyManager = TelephonyManager.from(host.getContext());
        mPhoneStateListener = new MyCallStateListener();
        mDataController = networkController.getMobileDataController();
    }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        if (arg == null) {
            int defaultPhoneId = SubscriptionManager.getDefaultDataPhoneId();
    ...
    private void toggleMobileData() {
        ...
        mDataController
                .setSubscriptionId(
                        1 - SubscriptionManager.getDefaultDataPhoneId());
