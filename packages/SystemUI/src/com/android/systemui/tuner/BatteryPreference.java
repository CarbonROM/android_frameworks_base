...
import static android.provider.Settings.System.STATUS_BAR_SHOW_BATTERY_PERCENT_PREV;
...
public class BatteryPreference extends DropDownPreference implements TunerService.Tunable {
    ...
    protected boolean persistString(String value) {
        ...
        Settings.System.putIntForUser(getContext().getContentResolver(), STATUS_BAR_SHOW_BATTERY_PERCENT,
                    v ? 2 : 0, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(getContext().getContentResolver(), STATUS_BAR_SHOW_BATTERY_PERCENT_PREV,
                    v ? 2 : 0, UserHandle.USER_CURRENT);
