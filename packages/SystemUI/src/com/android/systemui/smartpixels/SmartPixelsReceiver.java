...
public class SmartPixelsReceiver extends BroadcastReceiver {
    ...
    public SmartPixelsReceiver(Context context, boolean powerSave) {
        mContext = context;
        mPowerSaveEnable = powerSave;
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            mSmartPixelsEnable = (Settings.System.getInt(
                    mResolver, Settings.System.SMART_PIXELS_ENABLE, 0) == 1);
            mSmartPixelsOnPowerSave = (Settings.System.getInt(
                    mResolver, Settings.System.SMART_PIXELS_ON_POWER_SAVE, 0) == 1);
    ...
    public void powerSaveChanged(boolean powerSave) {
        if (powerSave == mPowerSaveEnable) return;
        mPowerSaveEnable = powerSave;
        mSettingsObserver.update();
    }
}
