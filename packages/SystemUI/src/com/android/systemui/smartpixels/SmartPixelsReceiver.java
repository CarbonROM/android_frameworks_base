    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            if ((Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.SMART_PIXELS_ON_POWER_SAVE,
               0, mCurrentUserId) != 0) && (Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.SMART_PIXELS_ENABLE,
               0, mCurrentUserId) == 0)) {
                if (pm.isPowerSaveMode() && !mSmartPixelsRunning) {
                    mContext.startService(smartPixels);
                    mSmartPixelsRunning = true;
                    Log.d(TAG, "Started SmartPixels");
                } else if (!pm.isPowerSaveMode() && mSmartPixelsRunning){
            ...
            } else if ((Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.SMART_PIXELS_ON_POWER_SAVE,
              0, mCurrentUserId) == 0) && (Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.SMART_PIXELS_ENABLE,
              0, mCurrentUserId) == 0) && mSmartPixelsRunning){
                mContext.stopService(smartPixels);
                mSmartPixelsRunning = false;
                Log.d(TAG, "Stopped SmartPixels");
            } else if ((Settings.System.getIntForUser(mContext.getContentResolver(), Settings.System.SMART_PIXELS_ENABLE,
              0, mCurrentUserId) != 0) && !mSmartPixelsRunning){
                mContext.startService(smartPixels);
                mSmartPixelsRunning = true;
                Log.d(TAG, "Started SmartPixels");
