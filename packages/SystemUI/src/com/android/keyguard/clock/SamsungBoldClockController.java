...
public class SamsungBoldClockController implements ClockPlugin {
    ...
    private TextClock mPreviewTime;
    private TextClock mPreviewDate;
    ...
    private void createViews() {
        mView = mLayoutInflater.inflate(R.layout.digital_clock_custom, null);
        ...
        mPreviewView = mLayoutInflater.inflate(R.layout.default_clock_preview, null);
        mPreviewTime = mPreviewView.findViewById(R.id.time);
        mPreviewTime.setFormat12Hour(Html.fromHtml("<strong>hh</strong><br>mm"));
        mPreviewTime.setFormat24Hour(Html.fromHtml("<strong>kk</strong><br>mm"));
        mPreviewDate = mPreviewView.findViewById(R.id.date);
    }
    ...
    public Bitmap getPreview(int width, int height) {
        ...
        // Use the custom preview view for preview
        View view = mPreviewView;

        // Initialize state of plugin before generating preview.
        setDarkAmount(1f);
        mPreviewTime.setTextColor(Color.WHITE);
        mPreviewDate.setTextColor(Color.WHITE);
