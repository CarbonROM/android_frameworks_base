...
public class SamsungBoldClockController implements ClockPlugin {
     ...
     */
    private TextClock mTextTime;

    /**
     * Date showing below time in preview view hierarchy.
     */
    private TextClock mTextDate;
    ...
    private void createViews() {
        ...
        mTextTime.setFormat12Hour(Html.fromHtml("<strong>hh</strong><br>mm"));
        mTextTime.setFormat24Hour(Html.fromHtml("<strong>kk</strong><br>mm"));
