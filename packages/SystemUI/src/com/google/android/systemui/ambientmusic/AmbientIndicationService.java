...
import com.google.android.systemui.ambientmusic.-;
...
extends BroadcastReceiver {
    ...
    public void onReceive(Context object, Intent intent) {
        ...
        if (object.equals("com.google.android.ambientindication.action.AMBIENT_INDICATION_SHOW")) {
            CharSequence charSequence = intent.getCharSequenceExtra("com.google.android.ambientindication.extra.TEXT");
            object = (PendingIntent)intent.getParcelableExtra("com.google.android.ambientindication.extra.OPEN_INTENT");
            long l = Math.min(Math.max(intent.getLongExtra("com.google.android.ambientindication.extra.TTL_MILLIS", 180000L), 0L), 180000L);
            this.mAmbientIndicationContainer.setIndication(charSequence, (PendingIntent)object);
