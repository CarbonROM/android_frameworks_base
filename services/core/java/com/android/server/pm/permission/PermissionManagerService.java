...
public class PermissionManagerService {
                    ...
                    switch (grant) {
                        ...
                        case GRANT_RUNTIME: {
                            ...
                            for (int userId : UserManagerService.getInstance().getUserIds()) {
                                ...
                                } else if (isAlwaysRuntimePermission(bp.getName) &&
                                        origPermissions.getRuntimePermissionState(bp.getName, userId) == null) {
                                   if (permissionsState.grantRuntimePermission(bp, userId)
                                           != PermissionsState.PERMISSION_OPERATION_FAILURE) {
                                       // We changed the permission, hence have to write.
    ...
    private void grantRequestedRuntimePermissionsForUser(PackageParser.Package pkg, int userId,
        ...
        for (String permission : pkg.requestedPermissions) {
            ...
            if (bp != null && (bp.isRuntime() || bp.isDevelopment())
                ...
                if (supportsRuntimePermissions  || isAlwaysRuntimePermission(bp.getName)) {
    ...
    private void grantRuntimePermission(String permName, String packageName, boolean overridePolicy,
        ...
        if (mSettings.mPermissionReviewRequired
                && pkg.applicationInfo.targetSdkVersion < Build.VERSION_CODES.M
                && bp.isRuntime() && !isAlwaysRuntimePermission(pkg)) {
            return;
        }
        ...
        if (pkg.applicationInfo.targetSdkVersion < Build.VERSION_CODES.M && !isAlwaysRuntimePermission(pkg)) {
