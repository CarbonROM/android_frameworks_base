...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    private int mScreenshotExpanded = TAKE_SCREENSHOT_EXPANDED;
        ...
        return new SinglePressAction(com.android.internal.R.drawable.ic_lock_power_screenshot,
            ...
            public void onPress() {
                if (Settings.System.getInt(mContext.getContentResolver(),
                   ...
                   takeScreenshot(mScreenshotExpanded);
                } else {
        ...
        public void setScreenshotType(int screenshotType) {
            if (Settings.System.getInt(mContext.getContentResolver(),
                ...
                mScreenshotSelectedRegion = screenshotType;
                       ...
                       Settings.System.SCREENSHOT_TYPE, 0) == 2) {
                mScreenshotExpanded = screenshotType;
            } else {
    ...
    private void checkSettings() {
        mScreenshotDelay = (Settings.System.getInt(mContext.getContentResolver(),
                Settings.System.SCREENSHOT_DELAY, 100) + 500);
    }
}
