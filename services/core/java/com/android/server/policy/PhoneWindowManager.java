...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private boolean[] haveEnabledCarbonGestures = new boolean[4];
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.Secure.getUriFor(
                    ...
                    UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.CARBON_CUSTOM_GESTURE), false, this,
                    UserHandle.USER_ALL);
            updateSettings();
        }
    ...
    private CarbonGesturesListener initCarbonGesture(Context context, int fingers, int keycode, CarbonGesturesListener.Directions direction) {
        return new CarbonGesturesListener(mContext, fingers, direction, new CarbonGesturesListener.Callbacks() {
            ...
            public void onSwipeGesture() {
                triggerVirtualKeypress(context, keycode);
            }
        });
    }

    private CarbonGesturesListener initCarbonScreenshotGesture(Context context, int fingers, CarbonGesturesListener.Directions direction) {
        return new CarbonGesturesListener(mContext, fingers, direction, new CarbonGesturesListener.Callbacks() {
            @Override
            public void onSwipeGesture() {
                mHandler.post(mScreenshotRunnable);
    ...
    private CarbonGesturesListener handleCarbonGesture(CCarbonGesturesListener gesture, int fingers, int value, CarbonGesturesListener.Directions direction) {
        if (value != 0) {
            if (haveEnabledCarbonGestures[direction.ordinal()]) return gesture;
            haveEnabledCarbonGestures[direction.ordinal()] = true;
            switch (value) {
                case 1000:
                    gesture = initCarbonScreenshotGesture(fingers, direction);
                    break;
                default:
                    gesture = initCarbonGesture(fingers, value, direction);
                    break;
            }
            ...
            if (!haveEnabledCarbonGestures[direction.ordinal()]) return gesture;
            haveEnabledCarbonGestures[direction.ordinal()] = false;
            mWindowManagerFuncs.unregisterPointerEventListener(gesture);
        }
        return null;
    }

     private void enableCarbonNavGestures(int fingers, int value, CarbonGesturesListener.Directions direction){
        int gestureIndex;
        switch (direction) {
            case RIGHT:
                mCarbonGesturesRight = handleCarbonGesture(mCarbonGesturesRight, fingers, value, direction);
                break;
            case LEFT:
                mCarbonGesturesLeft = handleCarbonGesture(mCarbonGesturesLeft, fingers, value, direction);
                break;
            case UP:
                mCarbonGesturesUp = handleCarbonGesture(mCarbonGesturesUp, fingers, value, direction);
                break;
            case DOWN:
                mCarbonGesturesDown = handleCarbonGesture(mCarbonGesturesDown, fingers, value, direction);
                break;
    ...
    public void updateSettings() {
        ...
        // Carbon Navigaton Gestures
            ...
            enableCarbonNavGestures(carbonCustomGestureFingers, carbonCustomGestureRight, CarbonGesturesListener.Directions.RIGHT);
            ...
            enableCarbonNavGestures(carbonCustomGestureFingers, carbonCustomGestureLeft, CarbonGesturesListener.Directions.LEFT);
            ...
            enableCarbonNavGestures(carbonCustomGestureFingers, carbonCustomGestureUp, CarbonGesturesListener.Directions.UP);
            ...
            enableCarbonNavGestures(carbonCustomGestureFingers, carbonCustomGestureDown, CarbonGesturesListener.Directions.DOWN);
