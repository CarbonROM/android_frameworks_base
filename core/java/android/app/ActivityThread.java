...
public final class ActivityThread extends ClientTransactionHandler {
    ...
    private class ApplicationThread extends IApplicationThread.Stub {
        ...
        public int TCTScrollForSShot(final boolean bForward,final int nDistance) {
            android.util.Log.i("sshot","==>activityThread TCTScrollForSShot : bForward = "+bForward+"/nDistance = "+nDistance);
            ...
            tu.mScreenRect.set(0, 0, act.getResources().getDisplayMetrics().widthPixels, act.getResources().getDisplayMetrics().heightPixels);
            ...
            android.util.Log.i("sshot","==>activityThread TCTScrollForSShot ScrollView = "+tu.mMainScrollView.toString() + "/id = " + tu.mMainScrollView.getId());
            if(nDistance == 0){
        ...
        public  Activity TCTGetTopActivity() {
            ...
            {
                android.util.Log.i("sshot","==>activityThread TCTGetTopActivity:" + acr.activity + "/mResumed = " + acr.activity.mResumed);
